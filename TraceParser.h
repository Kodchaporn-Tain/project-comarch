    ...
    MemoryAccess getNextAccess() {
        ...
        while (getline(file, line)) {
            ...
            if (ss >> type >> hex >> address) {
                ...
                // ถ้าดึงข้อมูลไม่ได้ โปรแกรมจะไม่ค้าง แต่จะข้ามไป
                errorCount++;
                
                // หมายเหตุ: หากไฟล์เทรซมีขนาดใหญ่มากและมี Error เยอะ 
                // การปริ้นท์เตือนทุกบรรทัดอาจทำให้โปรแกรมรันช้าลงได้ สามารถคอมเมนต์บรรทัดด้านล่างนี้ไว้ได้ครับ
                // cout << "[Warning] Data format error at line " << lineCount << ". Skipping..." << endl;
            }
        }
...
// ใส่ inline ป้องกัน Error Multiple Definition เวลาดึงไปใช้หลายที่
// =========================================================
inline void createDummyTraceFile(string filename) {
